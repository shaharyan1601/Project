...
import LeaveC from "components/LeaveC.png";
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(`${process.env.REACT_APP_NODE_URL}/myinfo/leave/${loginDate}`);
    ...
    <div className="leaves-list">
      <div className="flex job-open-list-heading">
        ...
        <div className="job-open-list-title">
          <h3><img src={LeaveC} alt="" /> LEAVES</h3>
        </div>
      </div>
